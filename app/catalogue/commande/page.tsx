...
function CommandeContent() {
  ...
  const capturerPosition = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => { setGpsStatut('error'); alert("Position non captee — pas de souci ! Ecrivez simplement votre adresse ci-dessus.") },
    ...
    <div style={{ minHeight: '100vh', background: '#faf9f7', fontFamily: "'DM Sans', sans-serif", paddingBottom: 40 }}>
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #ece9e3', padding: '16px', marginBottom: 16 }}>
          ...
          {typeCommande === 'abidjan' ? (
            <div>
              <label style={{ fontSize: 13, fontWeight: 500, color: '#555', display: 'block', marginBottom: 6 }}>Adresse de livraison *</label><p style={{ margin: '0 0 8px', fontSize: 11, color: '#999' }}>Ecrivez votre adresse et/ou partagez votre position GPS (recommande pour faciliter la livraison)</p>
